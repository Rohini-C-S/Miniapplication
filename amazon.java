...
class amazon{
  private static Scanner scan;
    ...
    static int newmerchid=100,product_id=1100;
    ...
    public static void amazonHome(){        
      ...
      System.out.println("2. Merchand Login");
...
private static void amazonadmin() {
    System.out.println("------Welcome to Amazon Admin------");
    System.out.println("1.Approvel List");
...
private static void new_order() {
    ...
    for(int i=0;i<pro_list.size();i++){
        System.out.printf("%-15s  %-15s  %-26s %-15s  %-15s %-15s  %-15s\n",pro_list.get(i).product_name,pro_list.get(i).product_brand,pro_list.get(i).product_details,pro_list.get(i).productId,pro_list.get(i).merchandid,pro_list.get(i).product_price,pro_list.get(i).product_dis);
    }
    order_id++;
    double org_amt=0;
    double amt=0,dis=0;
    ...
    for(int i=0;i<pro_list.size();i++){
        if(pro_list.get(i).productId==order_pro){
            ...
            ord_list.add(new orders(order_id,pro_list.get(i).product_name,pro_list.get(i).product_brand,pro_list.get(i).product_details,pro_list.get(i).productId,pro_list.get(i).merchandid,pro_list.get(i).product_price,pro_list.get(i).product_dis,user_list.get(user_index).user_id,status));
            set=false;
        }
    }        
    if(set==true){
        order_id--;
        System.out.println("Invalid product Id or the product you entered is not found");
    }
    else{         System.out.println("Press 1 to order now or 2 to add to cart");
         ...
         if(cart==1){
            for(int i=0;i<ord_list.size();i++){
                if(ord_list.get(i).productId==order_pro){                                                
                    ...
                    org_amt += amt-disamt;
                    his_list.add(new history(order_id,ord_list.get(i).product_name,ord_list.get(i).product_brand,ord_list.get(i).product_details,ord_list.get(i).productId, ord_list.get(i).product_price,ord_list.get(i).product_dis,
        ...
        else if(cart==2)
        {
            for(int i=0;i<ord_list.size();i++){
                if(ord_list.get(i).productId==order_pro){
                 String status="Ordered";
                    cart_list.add(new cart(order_id,ord_list.get(i).product_name,ord_list.get(i).product_brand,ord_list.get(i).product_details,ord_list.get(i).productId,ord_list.get(i).merchandid,ord_list.get(i).product_price,ord_list.get(i).product_dis,user_list.get(user_index).user_id,status));
                    his_list.add(new history(order_id,ord_list.get(i).product_name,ord_list.get(i).product_brand,ord_list.get(i).product_details,ord_list.get(i).productId,ord_list.get(i).product_price,ord_list.get(i).product_dis,user_list.get(user_index).user_id,"Order Pending"));
             } }
...
private static void order_hist() {
    ...
    System.out.printf("%-12s  %-12s %-12s  %-22s %-12s  %-12s %-12s || %-12s\n","Order_id","Product Name","Product Brand","Product Details","ProductID","Product Price","Product Discount","Status");
    System.out.println(s);
    for(int i=0;i<his_list.size();i++){
        if(his_list.get(i).user_id==user_list.get(user_index).user_id){
            System.out.printf("%-12s  %-12s  %-12s  %-22s %-12s  %-12s %-12s || %-12s\n",his_list.get(i).orderId,his_list.get(i).product_name,his_list.get(i).product_brand,his_list.get(i).product_details,his_list.get(i).productId,his_list.get(i).product_price,his_list.get(i).product_dis,his_list.get(i).status);
                check=1; }
    }
    if(check==1){
        System.out.println();
        ...
        if(cancel==1){
            ...
            if(can==true){
                System.out.println("Product id not found and try again later....");
            }
        }
    }       
    if(check==0){
...
private static void my_cart(){
        ...
        System.out.printf(" %-15s  %-15s  %-15s  %-26s  %-13s  %-15s %-15s \n","Order_Id","Product Name","Product Brand","Product Details","ProductID","Product Price","Product Discount");
        System.out.println(s);
        for(int i=0;i<cart_list.size();i++){
            if(ord_list.get(i).user_id==user_list.get(user_index).user_id){
                System.out.printf("%-15s  %-15s  %-15s %-26s  %-13s %-15s  %-15s\n",cart_list.get(i).orderId,cart_list.get(i).product_name,cart_list.get(i).product_brand,cart_list.get(i).product_details,cart_list.get(i).productId,cart_list.get(i).product_price,cart_list.get(i).product_dis);
                halt=0;
            }
        }
        if(halt==1){
        ...
        if(exit==1){
            ...
            for(int i=0;i<cart_list.size();i++){
                if(cart_list.get(i).productId==exit){                        
                    ...
                    his_list.add(new history(order_id,ord_list.get(i).product_name,ord_list.get(i).product_brand,ord_list.get(i).product_details,ord_list.get(i).productId, ord_list.get(i).product_price,ord_list.get(i).product_dis,user_list.get(user_index).user_id,"Delivered"));
                    cart_list.remove(i);
                    fg=false;                  
                }
            }    
...
private static void compare_product() {
    ...
    if(print==1){
        System.out.printf("%-12s  %-12s  %-12s  %-22s %-12s  %-12s %-12s \n","Merchand ID","Product Name","Product Brand","Product Details","ProductID","Product Price","Product Discount");
    }
    for(int i=0;i<pro_list.size();i++){
        if(pro_list.get(i).product_name.equals(pro_name)){
            System.out.printf("%-12s  %-12s  %-15s  %-22s %-12s  %-12s %-12s \n",pro_list.get(i).merchandid,pro_list.get(i).product_name,pro_list.get(i).product_brand,pro_list.get(i).product_details,pro_list.get(i).productId,pro_list.get(i).product_price,pro_list.get(i).product_dis);
        }
    }
    if(print==0){
...
private static void viewproduct(){
    System.out.printf("%-15s  %-15s  %-20s %-15s  %-15s %-15s  %-15s\n","Product Name","Product Brand","Product Details","ProductID","MerchantID","Product Price","Product Discount");
    System.out.println(s);
...
private static void crtModify(int modify_id) {
    System.out.println("1.Modify price: ");
        ...
        private static void display(ArrayList<products> tp) {
            for(int i=0;i<tp.size();i++){
                System.out.printf("%-15s  %-15s  %-20s %-15s  %-15s %-15s  %-15s\n",tp.get(i).product_name,tp.get(i).product_brand,tp.get(i).product_details,tp.get(i).productId,tp.get(i).merchandid, tp.get(i).product_price, tp.get(i).product_dis);
            }
            System.out.println("\tpress enter to continue.....!!");
            String s9 = scan.nextLine();
            System.out.print("\033[H\033[2J");
        ...
        public static void merchandlist(){
            m_List.add(new merchands( "rohini", "1111","Mobiles",101,"approved"));
            m_List.add(new merchands("selvi", "2222","Tablets",102,"approved"));
            m_List.add(new merchands("ramya", "3333","Furniture",103,"approved"));
            m_List.add(new merchands("pavi","4444","Laptops",104,"approved"));
        }
        public static void productlist(){
            pro_list.add(new products( "Mobiles", "Redmi","RAM-16GB ROM-256GB",1001,101,32000,5));
            pro_list.add(new products( "Tablets", "Samsung","RAM-32GB ROM-512GB",1002,102,45999,7));
            pro_list.add(new products( "Mobiles", "Oppo","RAM-32GB ROM-256GB",1009,101,29999,2));
            ...
            pro_list.add(new products( "Book", "MArk Twain","Greatest Humarised world",1008,104,5000,0));
        }
        public static void userlist(){
            user_list.add(new users( "keerthana", "1111",120000,90));
            user_list.add(new users( "nandhini", "2222",90000,91));
            user_list.add(new users( "priya", "9999",50000,92));
            user_list.add(new users( "sandhiya", "5555",40000,93));       
        }
    }
    ...
    class products extends amazon{
        ...
        products(String product_name,String product_brand,String product_details,int product_id,int merchandId,double product_price,double product_dis){
